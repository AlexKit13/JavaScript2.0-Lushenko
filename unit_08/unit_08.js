...
function t11() {
    ...
    let getDiv = document.querySelectorAll('.div-11');
    let out = '';
    let i = 0;
    while (i < getDiv.length) {
        out += getDiv[i].innerHTML + '_';
        i++;
    }
    outOne.innerHTML = out;
}
...
function t12() {
    let getDiv = document.querySelectorAll('.div-12');
    let i = 0;
    let out = '';
    while (i < getDiv.length) {
        out += getDiv[i].style.background = 'orange';
        i++;
    }
}
...
function t14() {
    const input = document.querySelectorAll('.i-14');
