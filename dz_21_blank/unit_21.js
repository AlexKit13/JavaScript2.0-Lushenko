...
function t3() {
    ...
    if (document.querySelector('.div-3_1')) {
        out.textContent = document.querySelector('.div-3_1').innerHTML;

    } else if (document.querySelector('.div-3_2')) {
        out.textContent = document.querySelector('.div-3_2').innerHTML;
    }
...
// Task 8 ============================================
/*  Дан блок div-8. Добавьте на него событие touch, которое при срабатывании окрашивает блок случаным цветом из массива a8=[red, green, blue, orge, pink, yellow] */
...
let w = 75;
function t10(event) {
    const block = document.querySelector('.div-10');
...
function t11(event) {
    ...
    out.innerHTML += event.changedTouches[0].radiusX + ' ' + event.changedTouches[0].radiusY;
