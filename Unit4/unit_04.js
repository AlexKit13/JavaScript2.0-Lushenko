...
function f9() {
    ...
    const checkElement = document.querySelector('.r-9');

    if (checkElement.checked) {
        out9.innerHTML = checkElement.value;
...
function f10() {
    ...
    const checkElement = document.querySelector('.i-10').value;
    out10.style.backgroundColor = checkElement;
}
...
function f11() {
    let checkElement = document.querySelector('.i-111');
    let checkEl = document.querySelector('.i-112');
    checkEl.value =  checkElement.value
...
function f12() {
    const out10 = document.querySelector('.out-12');
    const checkElement = document.querySelector('.i-12');
     out10.innerHTML  = checkElement.value
}
...
function f13() {
    const out10 = document.querySelector('.out-13');
    const checkElement = document.querySelector('.i-13');
    out10.innerHTML = checkElement.value;
}
...
function f15() {
    const textareaOne = document.querySelector('.i-15');
    const textareaTwo = document.querySelector('.t-15');
    const out = document.querySelector('.out-15');
    out.innerHTML = textareaOne.value;
...
function f16() {
    ...
    const option = document.querySelector('.s-16');

    out.innerHTML = option.value;
}
...
function f17() {
    ...
    const option = document.querySelector('.s-17');
    out.innerHTML = option.value
}
...
function f18() {
    ...
    const option = document.querySelector('.s-18');
...
document.querySelector('.s-201').onchange = () => {
