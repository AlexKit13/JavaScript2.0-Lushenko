...
function t2() {
    ...
    xhttp.open('GET', ' http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Alex');
    xhttp.send();
    function myFunction(data) {
...
function t5() {
    ...
    xhttp.open('GET', ' http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=5&Y-m-d h:m:s');
    xhttp.send();
    function myFunction(data) {
...
function t6() {
    ...
    xhttp.open('GET', ' http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=1&num2=4');
    xhttp.send();
    function myFunction(data) {
...
function t7() {
    ...
    xhttp.open('GET', ' http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=7$a7[rand(0,count($a7)-1)]');
    xhttp.send();
    function myFunction(data) {
