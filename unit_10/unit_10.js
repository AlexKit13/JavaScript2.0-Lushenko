...
let ar1 = ['Максим', 'Зима', 35, 8.5, false];
...
let ar3 = ['Максим', 'Зима', 35, 8.5];

function f3() {
    const outOne = document.querySelector('.out-3');
    outOne.innerHTML = ar3.length;
...
function f8() {
    ...
    const outTwo = document.querySelector('.out-8-1');
    let out = '';
    ar8[3] = 3.14;
    ar8[4] = 17;
    ar8[6] = 5;
...
function f10() {
    const outOne = document.querySelector('.out-10');
    let sum = 0;
...
function f11() {
    const outOne = document.querySelector('.out-11');
    let out = '';
    let t = ar11[2]
    ar11[2] = ar11[4]
    ar11[4] = t;
...
function f12() {
    const outOne = document.querySelector('.out-12');
    let out = '';
    let t = ar12[0];
...
function f13() {
    ...
    const outOne = document.querySelector('.out-13');
    let out = '';
...
function f14() {
    ...
    const outOne = document.querySelector('.out-14');
...
function f15() {
    ...
    const outOne = document.querySelector('.out-15');
...
function f16() {
    ...
    ar16_odd = [];
    ar16_even = [];
   let  odd_out = document.querySelector('.out-16-even');
   let  even_out = document.querySelector('.out-16-odd');
    let out = '';
    ...
    odd_out.innerHTML = out;
    out = '';
    for (let i = 0; i < ar16_even.length; i++) {
        out += ar16_even[i] + ' ';
    }
    even_out.innerHTML = out;
}
...
function f17() {
    const outOne = document.querySelector('.out-17');
    let out = '';
...
function f18() {
    const outOne = document.querySelector('.out-18');
let max = ar18[0];
...
function f19() {
    const outOne = document.querySelector('.out-19');
    let min = ar19[0];
...
function f20() {
    const outOne = document.querySelector('.out-20');
    let sum = 0;
