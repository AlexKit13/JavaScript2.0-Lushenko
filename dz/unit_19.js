...
function t5() {
    let page = document.querySelector('.div-5');
...
document.querySelector('.ch-8[type=checkbox]').oncontextmenu = t8;
// ваше событие здесь!!!
...
document.getElementById('myImage').oncontextmenu = t9;
// ваше событие здесь!!!
...
function t10() {
    document.getElementById('imageBlock10').src = "img/2.png";
}

document.getElementById('imageBlock10').onmouseenter = t10;
// ваше событие здесь!!!
...
function t11() {
    document.getElementById('imageBlock11').src = "img/2.png";
    document.getElementById('imageBlock11').onmouseleave = () => {
        document.getElementById('imageBlock11').src = "img/1.png";
    }
}

document.getElementById('imageBlock11').onmouseenter = t11;
// ваше событие здесь!!!
...
function t18() {
     this.textContent = this.offsetWidth + 'px';
